...
import {extractDeclarations, extractProperty, extractValue, extractGroups, hasGroup, exctractAtRuleReplacement} from './lib/postcss-typography-helpers';

describe('postcss-typography plugin', () => {

	'use strict';

	it('should return array of parsed declarations or empty array if no declarations were found', () => {
	...
	it('should return css declaration property from string',() => {
	...
	it('should return css declaration value from string', () => {
	...
	it('should return array of correction groups from string', () => {
	...
	it('should return true if string contains correction groups(s)', () => {
	...
	it('should return atRule substring from string', () => {
